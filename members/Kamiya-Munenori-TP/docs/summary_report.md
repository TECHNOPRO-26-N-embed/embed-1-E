...
RTCモジュールを採用し休憩時刻を記録することで自己分析をできるようにしました。
また、シンプルな操作性を重視し、ボタン1つで操作が完結する構成にしました。
...
**どう対処したか：**
原因として、初期設定ミスやビルド時間が関係していると考え、見直した結果誤差を5秒まで減らすことができた。

**そこから何がわかったか：**
ハードウェアの状態や設定ミスも疑う視点が大切だと実感した。
